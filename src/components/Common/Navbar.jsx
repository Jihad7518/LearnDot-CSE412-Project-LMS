...
function Navbar() {
  ...
  return (
    <div
      className={`flex h-20 items-center justify-center border-b-[1px] border-b-richblack-700 font-Poppins ${
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        <nav className="hidden md:block">
          <ul className="flex gap-x-12 text-richblack-25 text-[17px]">
